<script>
    ...
    // the above commented out code can be summarised as follows
    // $todos use '$' to subscribe and unsubscribe from global store
...
<div>
    ...
    <div class="other-buttons-container">
        ...
        <div>
            <button class="button" on:click={clearCompleted}
